...
import '../masraf/masraf_liste_screen.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          _BelgeKarti(
            ...
            iconBg: AppColors.negative.withValues(alpha: 0.12),
            baslik: 'Masraflar',
            altyazi: 'Saha gider fişleri (benzin, otopark…)',
            aktif: true,
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const MasrafListeScreen()),
            ),
          ),
        ],
      ),
